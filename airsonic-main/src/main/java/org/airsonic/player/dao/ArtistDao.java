...
public class ArtistDao extends AbstractDao {
    ...
    public void markNonPresent(Instant lastScanned) {
        ...
        update("update artist set present=false where id between ? and ? and last_scanned < ? and present", minId, maxId, lastScanned);
    }
    ...
    public void expunge() {
        ...
        update("delete from artist where id between ? and ? and not present", minId, maxId);
    }
