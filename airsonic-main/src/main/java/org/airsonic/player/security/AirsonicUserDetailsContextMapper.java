...
@Component
public class AirsonicUserDetailsContextMapper implements UserDetailsContextMapper {
    // ~ Instance fields
    // ================================================================================================

    private final Logger logger = LoggerFactory.getLogger(AirsonicUserDetailsContextMapper.class);
