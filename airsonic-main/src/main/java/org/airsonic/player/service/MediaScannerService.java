...
public class MediaScannerService {
    ...
    public synchronized void schedule() {
        ...
        LOG.info("Automatic media library scanning scheduled to run every {} day(s), starting at {}.", daysBetween, firstTime);
    ...
    private void doScanLibrary() {
        ...
        try {
            ...
            LOG.info("Scanned media library with {} entries.", scanCount);
