...
public class SearchServiceTestCase {
  ...
  private synchronized void populateDatabase() {
     ...
     * if you test immediately after initialization in 1 method. It may be improved later.
     */
    try {
  ...
  public void testSearchTypical() {
    ...
    Assert.assertEquals("(0) Specify '" + query + "' as query, total Hits is",
        1, result.getTotalHits());
    Assert.assertEquals("(1) Specify artist '" + query + "' as query. Artist SIZE is",
        0, result.getArtists().size());
    Assert.assertEquals("(2) Specify artist '" + query + "' as query. Album SIZE is",
        0, result.getAlbums().size());
    Assert.assertEquals("(3) Specify artist '" + query + "' as query, MediaFile SIZE is",
        1, result.getMediaFiles().size());
    Assert.assertEquals("(4) ", MediaType.ALBUM, result.getMediaFiles().get(0).getMediaType());
    Assert.assertEquals("(5) Specify artist '" + query + "' as query, and get a album. Name is ",
        "_ID3_ALBUMARTIST_ Sarah Walker/Nash Ensemble",
        result.getMediaFiles().get(0).getArtist());
    Assert.assertEquals("(6) Specify artist '" + query + "' as query, and get a album. Name is ",
    ...
    Assert.assertEquals("Specify '" + query + "' as query, total Hits is",
        1, result.getTotalHits());
    ...
    Assert.assertEquals("(9) Specify '" + query + "' as query, and get a song. MediaFile SIZE is ",
    ...
    Assert.assertEquals("(11) Specify album '" + query + "' as query, total Hits is",
        2, result.getTotalHits());
    Assert.assertEquals("(12) Specify album '" + query + "', and get a song. Artist SIZE is",
        0, result.getArtists().size());
    Assert.assertEquals("(13) Specify album '" + query + "', and get a song. Album SIZE is",
        0, result.getAlbums().size());
    ...
    Assert.assertEquals("(16) Specify album '" + query + "', and get songs. The second song is ",
    ...
    ParamSearchResult<Album> albumResult =
        searchService.searchByName(query, 0, Integer.MAX_VALUE, allMusicFolders, Album.class);
    Assert.assertEquals("(17) Specify album name '" + query + "' as the name, and get an album.",
        1, albumResult.getItems().size());
    ...
    Assert.assertEquals("(19) Whether the acquired album contains data of the specified album name",
        1L, albumResult.getItems().stream()
          .filter(r -> "_ID3_ALBUM_ Sackcloth \'n\' Ashes"
          .equals(r.getName()))
          .count());  
     ...
     */
    query = "lker/Nash";
    ParamSearchResult<ArtistID3> artistId3Result =
        searchService.searchByName(query, 0, Integer.MAX_VALUE, allMusicFolders, ArtistID3.class);
    Assert.assertEquals("(20) Specify '" + query + "' as the name, and get an artist.",
        0, artistId3Result.getItems().size());
    ParamSearchResult<Artist> artistResult = searchService.searchByName(query,
        0, Integer.MAX_VALUE, allMusicFolders, Artist.class);
    Assert.assertEquals("(21) Specify '" + query + "' as the name, and get an artist.",
        0, artistResult.getItems().size());
    ...
    Assert.assertEquals("(22) Specify MAX_VALUE as the upper limit, and randomly acquire songs.",
        11, allRandomSongs.size());
    ...
    Assert.assertEquals("(23) Specify 1900 as 'fromYear', and randomly acquire songs.",
        7, allRandomSongs.size());
    ...
    allRandomSongs = searchService.getRandomSongs(randomSearchCriteria);
    Assert.assertEquals("(24) Specify music as 'genre', and randomly acquire songs.",
        0, allRandomSongs.size());
    ...
    List<MediaFile> allRandomAlbums = searchService
        .getRandomAlbums(Integer.MAX_VALUE, allMusicFolders);
     ...
     * Acquisition of maximum number(5).
     */
    List<Album> allRandomAlbumsId3 = searchService
        .getRandomAlbumsId3(Integer.MAX_VALUE, allMusicFolders);
    Assert.assertEquals(
    ...
    Assert.assertEquals("(28) Specify '" + query + "', total Hits is",
        4, result.getTotalHits());
    Assert.assertEquals("(29) Specify '" + query + "', and get an artists. Artist SIZE is ",
        4, result.getArtists().size());
    Assert.assertEquals("(30) Specify '" + query + "', and get a artists. Album SIZE is ",
        0, result.getAlbums().size());
     ...
     * ARTIST -> _ID3_ALBUMARTIST_ Sarah Walker/Nash Ensemble
     * (The result must not contain duplicates. And ALBUMARTIST must be returned correctly.)
     */
    count = result.getArtists()
        .stream()
        .filter(a -> a.getName().startsWith("_ID3_ALBUMARTIST_"))
        .count();
    ...
    Assert.assertEquals("(35) Can the normal case be implemented.",
        0, result.getArtists().size());
    Assert.assertEquals("(36) Can the normal case be implemented.",
        0, result.getAlbums().size());
    Assert.assertEquals("(37) Can the normal case be implemented.",
        1, result.getMediaFiles().size());
    Assert.assertEquals("(38) Can the normal case be implemented.",
        MediaType.ALBUM, result.getMediaFiles().get(0).getMediaType());
