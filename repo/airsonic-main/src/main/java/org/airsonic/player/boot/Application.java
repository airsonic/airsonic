...
import org.airsonic.player.spring.AirsonicPropertySourceConfigurer;
...
@ImportResource(value = {"classpath:/applicationContext-service.xml",
        ...
        "classpath:/airsonic-servlet.xml"})
public class Application extends SpringBootServletInitializer implements EmbeddedServletContainerCustomizer {
    ...
    private static SpringApplicationBuilder doConfigure(SpringApplicationBuilder application) {
        ...
        return application.sources(Application.class).web(true).initializers(new AirsonicPropertySourceConfigurer());
    }
    ...
    public void customize(ConfigurableEmbeddedServletContainer container) {
        ...
        try {
            ...
            if(tomcatESCF.isInstance(container)) {
                ...
                Class<?> tomcatApplicationClass = Class.forName("org.airsonic.player.boot.TomcatApplication");
