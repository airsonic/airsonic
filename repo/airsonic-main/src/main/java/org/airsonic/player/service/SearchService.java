...
public class SearchService {
    ...
    public SearchResult search(SearchCriteria criteria, List<MusicFolder> musicFolders, IndexType indexType) {
        ...
        try {
            ...
            Analyzer analyzer = new AirsonicAnalyzer();
    ...
    private IndexWriter createIndexWriter(IndexType indexType) throws IOException {
        ...
        return new IndexWriter(FSDirectory.open(dir), new AirsonicAnalyzer(), true, new IndexWriter.MaxFieldLength(10));
    }
    ...
    private class AirsonicAnalyzer extends StandardAnalyzer {
        private AirsonicAnalyzer() {
