...
import org.airsonic.player.service.upnp.AirsonicContentDirectory;
...
public class UPnPService {
    ...
    private AirsonicContentDirectory airsonicContentDirectory;
    ...
    private LocalDevice createMediaServerDevice() throws Exception {
        ...
        LocalService<AirsonicContentDirectory> contentDirectoryservice = new AnnotationLocalServiceBinder().read(AirsonicContentDirectory.class);
        contentDirectoryservice.setManager(new DefaultServiceManager<AirsonicContentDirectory>(contentDirectoryservice) {

            @Override
            protected AirsonicContentDirectory createServiceInstance() throws Exception {
                return airsonicContentDirectory;
            }
        });
    ...
    public void setAirsonicContentDirectory(AirsonicContentDirectory airsonicContentDirectory) {
        this.airsonicContentDirectory = airsonicContentDirectory;
    }
}
